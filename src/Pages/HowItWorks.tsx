...
const HowItWorks = () => {
  return (
    <Box sx={pageHeight}>
      <Box sx={imgAndText}>
        <Box sx={firstTextBox}>
          <Typography sx={text1}>How to rent on Chubby Dog?</Typography>
          <Typography sx={text2}>
            Access items without owning them by renting them from people in your
            neighbourhood in a few easy steps.
          </Typography>
        </Box>
        <Box sx={imgGroup}>
          <img
            src={girlTablet}
            style={{ height: "25rem", marginTop: "-4rem" }}
          />
        </Box>
      </Box>
      ...
      <Box sx={imgAndText}>
        <Box sx={secondTextBox}>
          ...
          <Typography sx={text2}>Create your account</Typography>
          <Typography sx={text2}>or</Typography>
          <Typography sx={text2}>Sign in with Gmail</Typography>
        </Box>
        <Box sx={bannerDisplay}>
          <img
            src={banner}
            style={{ height: "30rem", width: "100%", marginTop: "-10rem" }}
          />
        </Box>
      </Box>
      ...
      <Box sx={imgAndText}>
        ...
        <Box sx={thirdTextBox}>
          <Typography sx={text1}>List your item</Typography>
          <Box sx={text3}>
            <p>1. Select your category</p>
            <p>2. Choose a title</p>
            <p>3. Write a describtion</p>
            <p>4. Set a price</p>
            <p>5. Show your location</p>
            <p>6. Add an image</p>
          </Box>
        </Box>
      </Box>
      ...
      <Box sx={imgAndText2}>
        <Box sx={fourthTextBox}>
          <Typography sx={text4}>Ready to go!</Typography>
          <Typography sx={text5}>
            It is that easy!
            <Link to="/signin" style={{ textDecoration: "none" }}>
              <Button sx={btnStyle}>Sign up today</Button>
            </Link>
          </Typography>
        </Box>
