  ...
  return (
    ...
    >
      ...
      <><img
          ...
          alt="profile picture" /><Typography variant="h1" component="h1" sx={{ marginTop: "1rem" }}>
            {currentUser.email}
          </Typography><Typography variant="h2" component="h2" sx={{ marginTop: "2rem" }}>
            About me
            ...
            rows={3}
            value={description}
            onChange={(e) => setDescription(e.target.value)} /><Typography variant="h2" component="h2" sx={{ marginTop: "2rem" }}>
            Your listings
          </Typography></>
      ) : (
        <>
          <Typography variant="h5">You need to be signed in to view this page</Typography>
