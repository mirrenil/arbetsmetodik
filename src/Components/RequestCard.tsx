    ...
    return (
        <Box
            sx={{
                ...
                minWidth: "20rem",
                maxWidth: "20rem",
                height: { xs: "15rem", md: "15rem", lg: "15rem", xl: "15rem" },
        ...
        >
            ...
            <Box sx={reqStatusContainer}>
                ...
                {isMySentRequest && reqStatus == pending ? (
                    <>
                        <Typography
                            sx={[reqStatusStyle, pendingStyle]}
                            variant="h5"
                        >
                            Pending...
                        </Typography>
                ...
                {isMySentRequest && reqStatus === accepted ? (
                    <Typography
                        sx={[acceptedStyle, reqStatusStyle]}
                        variant="h5"
                    >
                ...
                {!isMySentRequest && reqStatus === accepted ? (
                    <Typography
                        sx={[reqStatusStyle, acceptedStyle]}
                        variant="h5"
                    >
