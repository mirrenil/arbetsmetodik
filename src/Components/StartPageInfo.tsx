    ...
    <Box sx={mainPageInfoBox}>
      ...
      >
        <Box>
          <Typography
            sx={{
              fontSize: { xs: "none", md: "30px", lg: "50px", xl: "50px" },
            }}
          >
          ...
          <Box sx={infoMainParagraph}>
            <Typography
              sx={{
                fontSize: { xs: "none", md: "12px", lg: "16px", xl: "16px" },
              }}
            >
              Borrow almost anything from people nearby for jobs at home, fun
              experiences or work., Borrow almost anything from people nearby
              for jobs at home, fun experiences or work.,Borrow almost anything
              from people nearby for jobs at home, fun experiences or
              work.,Borrow almost anything from people nearby for jobs at home,
      ...
      <Box sx={infoSecTextBox}>
        <Box sx={infoSecText}>
          ...
          >
            ...
            >
              We have everything for <br /> you
            </Typography>
            <Box sx={infoSecParagraph}>
              <Typography
                sx={{
                  fontSize: { xs: "none", md: "14px", lg: "16px", xl: "16px" },
                }}
              >
                Borrow almost anything from people nearby for jobs at home, fun
                experiences or work., Borrow almost anything from people nearby
                for jobs at home, fun experiences or work.,Borrow almost
                anything from people nearby for jobs at home, fun experiences or
                work.,Borrow almost anything from people nearby for jobs at
